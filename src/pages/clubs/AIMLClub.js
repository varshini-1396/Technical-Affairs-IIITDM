...
const clubData = {
  ...
  description: `The AI/ML Club at IIITDM Kancheepuram is dedicated to exploring and advancing the fields of Artificial Intelligence and Machine Learning. We provide a platform for students to learn about cutting-edge AI/ML algorithms, frameworks, and applications through workshops, seminars, and hands-on projects. Our members engage in various activities including model building, data analysis, and participation in national-level AI/ML competitions, contributing to the institute's research and development efforts.`,
  core: [
    {
      name: 'John Doe',
      role: 'Club Head',
