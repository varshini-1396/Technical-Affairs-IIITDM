...
const clubData = {
  name: 'AI/ML Club',
  logo: '/images/clubs/aiml-logo.jpg',
  description: `The AI/ML Club at IIITDM Kancheepuram is dedicated to exploring and advancing the frontiers of artificial intelligence and machine learning. 
    Our club provides a platform for students to learn about cutting-edge AI/ML technologies, algorithms, and applications. We organize workshops, 
    hackathons, and research projects covering topics like deep learning, computer vision, natural language processing, and reinforcement learning. 
    Members get hands-on experience with popular frameworks like TensorFlow and PyTorch, and work on real-world AI/ML projects.`,
  core: [
    {
      name: 'John Doe',
      role: 'Club Head',
  ...
  links: {
    website: 'https://aiml.iiitdm.ac.in',
    instagram: 'https://instagram.com/aiml_iiitdm',
    github: 'https://github.com/aiml-iiitdm'
  }
};
