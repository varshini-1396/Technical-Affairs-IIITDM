...
const clubData = {
  ...
  description: `The Aeromodelling Club at IIITDM Kancheepuram is dedicated to fostering innovation in aerospace engineering and model aircraft design. Our club provides a platform for students to learn about aerodynamics, flight mechanics, and aircraft design through hands-on experience. We organize workshops on RC aircraft building, flight simulation, and participate in national-level competitions. Members get the opportunity to work on various projects including fixed-wing aircraft, quadcopters, and autonomous drones.`,
  core: [
    {
      name: 'John Doe',
      role: 'Club Head',
