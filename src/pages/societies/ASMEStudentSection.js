...
const clubData = {
  ...
  description: `The ASME Student Section at IIITDM Kancheepuram is a student chapter of the American Society of Mechanical Engineers. We focus on mechanical engineering innovation, design, and manufacturing. The section organizes technical workshops, design competitions, and industry visits. Our members actively participate in ASME competitions, contribute to research projects, and develop practical engineering skills through hands-on projects and collaborations with industry professionals.`,
  core: [
    {
      name: 'Rahul Kumar',
      role: 'Section Chair',
